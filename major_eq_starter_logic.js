// const { polyline, Polyline } = require("leaflet");
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  function tectonicStyle(features) {
    return {
      opacity: 1,
      color: "orange",
      stroke: true,
  ...
  d3.json("https://github.com/fraxen/tectonicplates").then(function(data) {
    console.log(data);
    L.geoJSON(data).addTo(Platesdata,
      {
     color: "ff6500",
